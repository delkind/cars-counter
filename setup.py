...
extensions = [
    Extension(
        'src.utils.compute_overlap',
        ['src/utils/compute_overlap.pyx']
    ),
]
...
setuptools.setup(
    name='cars-counter',
    version='0.0.1',
    description='Cars counter based on https://github.com/fizyr/keras-retinanet',
    url='https://github.com/fizyr/keras-retinanet',
    author='David Elkind',
    author_email='david.elkind@gmail.com',
    maintainer='David ELkind',
